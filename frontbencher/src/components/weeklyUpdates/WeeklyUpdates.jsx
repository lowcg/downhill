            ...
            <div className='relative flex flex-col gap-[24px] items-center px-4 sm:px-20 w-full'>
                ...
                <div className='flex flex-col items-center mb-36 mt-12 sm:mb-64 lg:mb-96 w-full '>
                    <form className='flex flex-col items-center gap-10 w-full'>
                        <input type="text" placeholder='Your Name' className='w-[50%] h-[40px] bg-transparent font-geistRegular focus:border-orange border-b border-gray px-4 focus:ring-0 focus:ring-offset-0 outline-none' />
                        <input type="email" placeholder='Your Email' className='w-[50%] h-[40px] bg-transparent font-geistRegular focus:border-orange border-b border-gray px-4 focus:ring-0 focus:ring-offset-0 outline-none' />
